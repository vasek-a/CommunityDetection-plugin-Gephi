...
public abstract class ChartUtils {
    ...
    public static void scaleChart(CategoryPlot plot) {
    ...
    public static XYSeries createXYSeries(Map<Integer, Integer> data, String name) {
	XYSeries series = new XYSeries(name);
	int i = 0;
	for (Iterator it = data.entrySet().iterator(); it.hasNext();) {
	    Map.Entry<Integer, Integer> d = (Map.Entry<Integer, Integer>) it.next();
