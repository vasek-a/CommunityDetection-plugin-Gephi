...
public abstract class ChartUtils {
    ...
    public static XYSeries createXYSeries(Map<String, Integer> data, String name) {
	XYSeries series = new XYSeries(name);
	int i = 0;
	for (Iterator it = data.entrySet().iterator(); it.hasNext();) {
		Map.Entry<String, Integer> n = (Map.Entry<String, Integer>) it.next();
	    Map.Entry<Integer, Integer> d = Map.entry(Integer.parseInt(n.getKey()), n.getValue());
